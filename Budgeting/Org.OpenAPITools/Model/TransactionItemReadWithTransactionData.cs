...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionItemReadWithTransactionData")]
    public partial class TransactionItemReadWithTransactionData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionItemReadWithTransactionData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionItemReadWithTransactionData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionItemReadWithTransactionData" /> class.
        /// </summary>
        ...
        /// <param name="timestamp">Timestamp must be a valid datetime. (required).</param>
        /// <param name="transactionUuid">UUID of the transaction. (required).</param>
        public TransactionItemReadWithTransactionData(decimal amount = default(decimal), string name = default(string), string description = default(string), Guid purchaseCategoryUuid = default(Guid), Guid uuid = default(Guid), string categoryName = default(string), string categoryDescription = default(string), List<string> tagNames = default(List<string>), DateTime timestamp = default(DateTime), Guid transactionUuid = default(Guid))
        {
            this.Amount = amount;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TransactionItemReadWithTransactionData and cannot be null");
            }
            this.Name = name;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for TransactionItemReadWithTransactionData and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("categoryName is a required property for TransactionItemReadWithTransactionData and cannot be null");
            }
        ...
        /// </summary>
        /// <value>UUID of the transaction.</value>
        [DataMember(Name = "transaction_uuid", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionItemReadWithTransactionData {\n");
