...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Token : IValidatableObject
    {
        ...
        public Token(string accessToken = default(string), string tokenType = default(string))
        {
            // to ensure "accessToken" is required (not null)
            if (accessToken == null)
            {
                throw new ArgumentNullException("accessToken is a required property for Token and cannot be null");
            }
            this.AccessToken = accessToken;
            // to ensure "tokenType" is required (not null)
            if (tokenType == null)
            {
                throw new ArgumentNullException("tokenType is a required property for Token and cannot be null");
            }
